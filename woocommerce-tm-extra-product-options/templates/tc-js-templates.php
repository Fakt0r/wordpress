    ...
    <dl class="tm-extra-product-options-totals tm-custom-price-totals">
        ...
        <# if (data.show_final_total==true){ #><?php echo apply_filters('wc_epo_template_before_final_total','');?>
            ...
            <?php if ( get_bloginfo('language') =='de-DE-formal' ) : ?>
                <dt class="tm-final-totals">Gesamtsumme</dt>
                <dd class="tm-final-totals">
					<span class="price amount final">{{{ data.formatted_final_total }}}  (exkl. MWSt.)</span>
				</dd>
				<?php else: ?>
                <dt class="tm-final-totals">{{{ data.final_total }}}</dt>
                <dd class="tm-final-totals">
					<span class="price amount final">{{{ data.formatted_final_total }}}  (excl. Tax)</span>
				</dd>
